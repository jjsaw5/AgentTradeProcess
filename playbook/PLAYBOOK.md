...
| 2026-09-18 | ≈ +$1,050 (5x SPY 759C + paper 761C), flat by 12:00 | B | Witching-release trade. Entry BEFORE confirmation (chase, 1-for-1); exit by the book — scaled into strength, flat before 3:45. Rule-following exit rescued a rule-bending entry. |
| 2026-09-21 | ≈ +$2,190 (+177%, $1,237→$3,426), 7x 0DTE index calls, flat by 11:20 | B | Gap-and-go trend day. Chase entry again (2-for-2); textbook exit — banked 5 of 7 into strength, flat by 11:20. Journaled: "two wins is when a rule-break normalizes." |
| 2026-09-22 | ≈ −$884 (−25.4%, $3,501→$2,612), 15 round trips, 6W/8L/1 scratch | **D** | **The recovery-trade day.** Brief called positive-gamma GLUE ("fade edges, don't trade the middle"); SPY ranged 2.55 pts all day. Nine of 15 trades were 0DTE index contracts inside that range, flipping direction eight times (calls→puts→calls), losses growing as the day went on (−$212 → −$408 → −$366) with holding times shrinking to minutes. Roughly −$200 to the market, −$700 to the drawdown. The one trigger-following trade (MRNA 172.5C after the 172.94 reclaim — the card's own bull branch) was +$397, the day's best. No resting stops; manual exits were fast, which kept it at −25%. **Owner's reflection (9/23): "I fell into the… I lost money… I can get it back — on a very clear sideways churn day."** Named: recovery trading. A pin day is the perfect trap for it — every loss is followed within minutes by something that looks like the chance to get it back. **RULE (owner's, written 9/23, in force until the owner rewrites it): after any losing trade on a day the brief calls glue/pin, I am DONE with the indexes for the day. Not for 30 minutes — done. If the tape later breaks, that is a different regime and the plan re-arms; if it keeps churning, there was nothing there anyway.** Conditional on the regime, not the loss; binary, so there is nothing to negotiate with at 12:24. Note: the review process initially recorded this day as "owner flat" from position snapshots — corrected 9/23; R-3 proposed. |
| 2026-09-23 | ≈ +$2,210 (+84.5%, $2,612→$4,820), 5 round trips, 5W, flat by 10:33 | A− | Rates-driven break (hot PMI + Barr; TLT −1.1%). Short QQQ 745P ×4 (+233%, the trade of the day), SPY 772P/770P, plus MRNA/PLTR call scalps. **Every index leg carried a resting stop-limit and every one fired INTO the bounce** — third straight session of textbook exits. Ding: QQQ 745P (9:38) and SPY 772P (9:47) went in before the eligible candle (the 10:00 close today); the one rule-following entry (SPY 770P add at 10:17) was the smallest winner. Same read as 9/22 — the difference was stops and not touching the middle. Two-day net +37.7%. |
