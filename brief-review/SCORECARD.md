...
- **Regime: 13 HIT / 8 MIXED / 1 MISS — and 9/16 is the signature HIT:
  ...
  recorded.
- **Radar: fired-and-resolved confirmations paid 35/46 (76%).**
  CONF-FAILED lifetime 11 — two shapes: event-day cards confirming at
  tops (Warsh 8/28, jobs 9/4) and the fired-and-flat / strict-window
  class, now 8 (USO −9¢, SPY 9/10 −7¢, the 9/11 gap test −0.2%, SPY
  9/15 −7¢, SPY 9/16 +20¢-over-trigger **with its named 750 target
  printed in between** → R-2 PROPOSED, META 9/16 gap-chase). The two
  9/16 entries in this class are the first where the day-plan ledger
  ran the identical fires under written scale management and paid
...
- **Vol-card series (8 resolved):** NVDA ≈fair, MRVL ≈fair, PANW ≈fair,
