...
scoring database. **Data through graded session 2026-09-16.** If that is
...
| Ticker | Reason(s) |
|---|---|
| GME | I-2: bull flow lean in 3 consecutive briefs — ESCALATE TO FLAGGED, quantify the cumulative build |
| NVDA | I-2: bull flow lean in 3 consecutive briefs — ESCALATE TO FLAGGED, quantify the cumulative build |
| SPCX | I-4: moved +5.2% last session (2026-09-16) |
